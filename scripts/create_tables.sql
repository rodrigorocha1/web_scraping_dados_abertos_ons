CREATE TABLE `1_BALANCO_ENERGIA_DESSEM_DETALHADO` (
...
CREATE TABLE `2_BALANCO_ENERGIA_DESSEM_GERAL` (
  `id_param` int DEFAULT NULL,
  `din_programacaodia` datetime NOT NULL,
  `num_patamar` smallint NOT NULL,
  `cod_subsistema` varchar(2) NOT NULL,
...
CREATE TABLE `3_BALANCO_ENERGIA_SUBSISTEMA` (
  `id_param` int DEFAULT NULL,
...
CREATE TABLE `4_CAPACIDADE_INSTALADA_GERACAO` (
  `id_param` int DEFAULT NULL,
  `id_subsistema` varchar(3) NOT NULL,
...
CREATE TABLE `5_CAPACIDADE_TRANSFORMACAO_REDE_BASICA` (
  `id_param` int DEFAULT NULL,
  `id_subsistema` varchar(3) NOT NULL,
  `nom_subsistema` varchar(20) NOT NULL,
  `id_estado` varchar(2) NOT NULL,
